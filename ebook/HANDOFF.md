...
> If you were given `logic-pro-crash-course-page.html` (the full 265-trick page), **do not
...
A single PDF — *Logic Pro Crash Course*, 265 tricks, 84 pages — for **$14.99 USD**, one-time.
...
- `<title>`: `Logic Pro Crash Course — 265 Tricks | Dannny McCcarthy`
