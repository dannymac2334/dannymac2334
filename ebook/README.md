...
A clickable eBook of **265 Logic Pro tricks** across **19 sections**, built from
...
| `dist/logic-pro-crash-course-page.html` | Full 265-trick web page. **Not for publication while the book is paid** — it gives the product away. Could become a free sample later. |
...
`dist/logic-pro-crash-course-page.html` — the full 265-trick web page — is **not for
